...
namespace Heimseiten\ContaoThemeSettingsBundle\ContaoManager;
...
class Plugin implements BundlePluginInterface
{
    ...
    {
        return [
            BundleConfig::create('Heimseiten\ContaoThemeSettingsBundle\HeimseitenContaoThemeSettingsBundle')
